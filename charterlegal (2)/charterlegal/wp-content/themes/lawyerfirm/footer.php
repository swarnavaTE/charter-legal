...
<footer id="colophon" class="site-footer">
	...
	<?php } ?>
		...
		<div class="site-info">
		<p><?php esc_html_e('All rights reservered to Charter Legal Consultancy FZ LLE', 'lawyerfirm');
                    esc_html_e(' - ', 'lawyerfirm') ?>
					<span><a target="_blank" rel="nofollow"
                       href="<?php echo esc_url('https://www.flawlessthemes.com/theme/lawyerfirm-best-lawyer-and-attorney-wordpress-theme-ever/'); ?>"><?php esc_html_e('Creative City, UAE.' , 'lawyerfirm'); ?></a></span>
